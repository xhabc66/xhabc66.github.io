...
var txt=["0","2","4","8","16","32","64","128","256","512","1024","2048","恭喜你，成功通关！","很抱歉，你失败了。是否重来？"];
...
function Print()
{
    ...
    {
        var x=Math.floor(i/n)+1,y=i%n+1;
        num[i].innerHTML=txt[a[x][y]];
        num[i].className="tile tile-"+txt[a[x][y]]+" tile-position-"+x+'-'+y;
    }
}
